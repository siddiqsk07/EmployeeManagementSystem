...
public class EmployeeServices {
	...
	public List<EmployeeData> addEmployees() {
		...
		list.add(new EmployeeData(102, "Siddiq", "IT"));
		list.add(new EmployeeData(104, "Wahid", "Admin"));
		list.add(new EmployeeData(101, "Srikanth", "IT"));
		list.add(new EmployeeData(103, "Khan", "HR"));
		list.add(new EmployeeData(105, "Saqib", "Finance"));
		list.add(new EmployeeData(102, "Wahid", "IT")); // duplicates allowed.
   ...
   //Q4.storeInLinkedHashMap()
	...
	public Map<Integer, EmployeeData> storeInTreeMap() {
        ...
        map.put(1, new EmployeeData(101,"Srikanth","IT"));
		map.put(2,new EmployeeData(102,"Wahid","IT"));
		map.put(4,new EmployeeData(104, "Siddiq","Admin"));
		map.put(3,new EmployeeData(103, "Khan", "HR"));
		map.put(5,new EmployeeData(105, "Saqib", "Finance"));
		map.put(1, new EmployeeData(102,"Wahid","IT"));
